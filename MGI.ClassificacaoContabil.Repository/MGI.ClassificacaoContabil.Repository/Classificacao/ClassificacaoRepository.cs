    ...
    public class ClassificacaoRepository : IClassificacaoRepository
    {
        ...
        public async Task<bool> InserirClassificacaoContabil(ClassificacaoContabilDTO classificacao)
        {
            ...
            new
            {
                ...
                status = 1,
                dataFinal = classificacao.MesAnoFim!.Value.ToString("01/01/yyyy"), // periodo de recuperacao
                dataInicial = classificacao.MesAnoInicio!.Value.ToString("01/MM/yyyy"),
        ...
        public async Task SalvarClassificacaoContabil(ClassificacaoContabilDTO classificacaoContabil)
        {
            ...
            await _session.Connection.ExecuteAsync(mergeCommand, new
            {
                ...
                MesAnoFim = classificacaoContabil.MesAnoFim!.Value.ToString("01/01/yyyy"), // periodo de recuperacao
                MesAnoInicio = classificacaoContabil.MesAnoInicio!.Value.ToString("01/MM/yyyy"),
